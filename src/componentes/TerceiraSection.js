    ...
    return(
        <section className={Style.terceiraSection}>
            ...
            <div className={Style.caixaTexto}data-aos="fade-down" data-aos-duration="3000">
                ...
                <h2 className={Style.txt2}>Através de um atendimento personalizado e proximo de nossos clientes, visamos cada vez mais trazer atualidades, e melhores condições para os PeterBanker’s.</h2>

            </div>

        
            <img src={peter} className={Style.peter} data-aos="fade-down" data-aos-duration="3000"/>
