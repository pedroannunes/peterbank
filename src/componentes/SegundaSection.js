    ...
    return(
        <section className={Style.segundaSection}>
            ...
            <div className={Style.caixaTxt} data-aos="fade-right" data-aos-duration="3000">
                <h1 className={Style.txt3}>Tenha condições <span className={Style.destaque}>futurísticas</span>,as menores <span className={Style.destaque}>taxas</span>, e melhores <span className={Style.destaque}>vantagens</span>!</h1>
